...
@section('title', trans('Edit Kenaikan Pangkat'))
            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Edit Dokumen kenaikan pangkat') }}
                    </p>
                </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="sk_cpns">{{ __('SK CPNS') }} </label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="sk_pns">{{ __('SK PNS') }} </label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="kartu_pegawai">{{ __('Kartu Pegawai') }} </label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="ijazah_baru">{{ __('Ijazah Terbaru') }} </label>
                                                    ...
                                                    @if ($promotion->promotion_type == 4)
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="pak_asli">{{ __('PAK Asli') }}</label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="pak_lama">{{ __('PAK Lama') }} </label>
                                                    ...
                                                    @if ($promotion->promotion_type == 3)
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label
                                                                    for="surat_tugas">{{ __('Surat Pernyataan Melaksanakan Tugas') }}</label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="sk_jabatan">{{ __('SK Jabatan') }} </label>
                                                    ...
                                                    @if ($promotion->promotion_type == 2)
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="sk_belajar">{{ __('SK Tugas Belajar') }}
                                                                </label>
                                ...
                                <div class="tab-pane fade" id="preview" role="tabpanel" aria-labelledby="preview-tab">
                                    <div class="accordion accordion-flush mt-3" id="accordionFlushDocument">
                                        @foreach ($promotion->files as $item)
